...
<div class="three wide column row left-sidebar">
    <div class="ui list" id="left-navigation">
        <div style="background-color: #0c299c; color: white;display: block; padding: 8px 10px 6px 16px;">Produits</div>
        <div class="catalog">
            <div class="menu_slider">Flyers et prospectus</div>
        ...
        <div class="catalog">
            <div class="menu_slider">Affiches</div>
            <div class="products hidden" style="display: none;">
                <div class="product">
