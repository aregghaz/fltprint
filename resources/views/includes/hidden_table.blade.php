...
<div  class="selectic_product_inputs" style="display: none">
    @if(!empty($productPrice))
        @foreach($productPrice as $value)
            @if(!empty($value->count_1))
                <input class="productPrice" title="" type="text" value="{{ $value->count_1 }}">
            @endif
            @if(!empty($value->count_2))
                <input class="productPrice" title="" type="text" value="{{ $value->count_2 }}">
            @endif
            @if(!empty($value->count_3))
                <input class="productPrice" title="" type="text" value="{{ $value->count_3 }}">
            @endif
            @if(!empty($value->count_4))
                <input class="productPrice" title="" type="text" value="{{ $value->count_4 }}">
            @endif
            @if(!empty($value->count_5))
                <input class="productPrice" title="" type="text" value="{{ $value->count_5 }}">
            @endif
            @if(!empty($value->count_6))
                <input class="productPrice" title="" type="text" value="{{ $value->count_6 }}">
            @endif
            @if(!empty($value->count_7))
                <input class="productPrice" title="" type="text" value="{{ $value->count_7 }}">
            @endif
            @if(!empty($value->count_8))
                <input class="productPrice" title="" type="text" value="{{ $value->count_8 }}">
            @endif
            @if(!empty($value->count_9))
                <input class="productPrice" title="" type="text" value="{{ $value->count_9 }}">
            @endif
            @if(!empty($value->count_10))
                <input class="productPrice" title="" type="text" value="{{ $value->count_10}}">
            @endif
            @if(!empty($value->count_11))
                <input class="productPrice" title="" type="text" value="{{ $value->count_11 }}">
            @endif
            @if(!empty($value->count_12))
                <input class="productPrice" title="" type="text" value="{{ $value->count_12 }}">
            @endif
            @if(!empty($value->count_13))
                <input class="productPrice" title="" type="text" value="{{ $value->count_13 }}">
            @endif
            @if(!empty($value->count_14))
                <input class="productPrice" title="" type="text" value="{{ $value->count_14 }}">
            @endif
            @if(!empty($value->count_15))
                <input class="productPrice" title="" type="text" value="{{ $value->count_15 }}">
            @endif
            @if(!empty($value->count_16))
                <input class="productPrice" title="" type="text" value="{{ $value->count_16 }}">
            @endif
            @if(!empty($value->count_17))
                <input class="productPrice" title="" type="text" value="{{ $value->count_17 }}">
            @endif
            @if(!empty($value->count_18))
                <input class="productPrice" title="" type="text" value="{{ $value->count_18 }}">
            @endif
            @if(!empty($value->count_19))
                <input class="productPrice" title="" type="text" value="{{ $value->count_19 }}">
            @endif
            @if(!empty($value->count_20))
                <input class="productPrice" title="" type="text" value="{{ $value->count_20 }}">
            @endif
            @if(!empty($value->count_21))
                <input class="productPrice" title="" type="text" value="{{ $value->count_21 }}">
            @endif
            @if(!empty($value->count_22))
                <input class="productPrice" title="" type="text" value="{{ $value->count_22 }}">
            @endif
        @endforeach
    @endif
    </div>

    <div class="selectic_format_inputs" style="display: none">
