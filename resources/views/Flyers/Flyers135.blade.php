        ...
        <div class="nine wide column">
            <div class="ui grid">
                <div class="fourteen wide column">
                    ...
                    {{$messageText }}
                    <h3>Prix</h3>
                    <input type='hidden' id="selectValue" name="selectValue" value="{{ $value }}" title="selectValue">
                    <input type='hidden' id="rootName" name="rootName" value="{{ $rootName }}" title="tableName">
                ...
                @if(!empty($thirdTable))
                    <div class="four wide column format_size">
                        <h3>Taille des formats</h3>
                        <table class="ui celled table" style="width: 100%!important;">
                            <thead>
                            <tr>
                                <th>Name</th>
                                <th>Status</th>
